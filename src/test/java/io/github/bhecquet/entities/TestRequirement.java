...
public class TestRequirement extends SquashTMTest {
    ...
    public void testCreateRequirementNoFolder() {
        ...
        Requirement.create(project, false, "myRequirement", "some description", new HashMap<>(), (ParentEntity) null, Requirement.Criticality.UNDEFINED);
    ...
    public void testCreateRequirementNoFolder2() {
        HttpRequestWithBody postRequest = (HttpRequestWithBody) createServerMock("POST", "/requirements", 200, REQUIREMENT_REPLY_DATA3, "request");
        Requirement.create(project, false, "myRequirement", "some description", new HashMap<>(), new ParentEntity(project), Requirement.Criticality.UNDEFINED);
        verify(postRequest).body(new JSONObject("{\"_type\":\"requirement\",\"parent\":{\"id\":1,\"_type\":\"project\"},\"current_version\":{\"_type\":\"requirement-version\",\"name\":\"myRequirement\",\"criticality\":\"UNDEFINED\",\"description\":\"some description\",\"status\":\"WORK_IN_PROGRESS\"}}"));
    }
    ...
    public void testCreateHighLevelRequirementNoFolder() {
        HttpRequestWithBody postRequest = (HttpRequestWithBody) createServerMock("POST", "/requirements", 200, REQUIREMENT_REPLY_DATA3, "request");
        Requirement.create(project, true, "myRequirement", "some description", new HashMap<>(), (ParentEntity) null, Requirement.Criticality.UNDEFINED);
        verify(postRequest).body(new JSONObject("{\"_type\":\"high-level-requirement\",\"parent\":{\"id\":1,\"_type\":\"project\"},\"current_version\":{\"_type\":\"requirement-version\",\"name\":\"myRequirement\",\"criticality\":\"UNDEFINED\",\"description\":\"some description\",\"status\":\"WORK_IN_PROGRESS\"}}"));
    }
    ...
    public void testCreateRequirementNoName() {
        ...
        Requirement.create(project, false, null, "some description", new HashMap<>(), (ParentEntity) null, Requirement.Criticality.UNDEFINED);
    }

    @Test
    public void testCreateRequirementWithCustomFields() {
        HttpRequestWithBody postRequest = (HttpRequestWithBody) createServerMock("POST", "/requirements", 200, REQUIREMENT_REPLY_DATA3, "request");
        Requirement.create(project, false, "myRequirement", "some description", Map.of("APP", List.of("comp1", "comp2")), (ParentEntity) null, Requirement.Criticality.UNDEFINED);
    ...
    public void testCreateRequirementWithFolder() {
        ...
        RequirementFolder requirementFolder2 = new RequirementFolder(
                ...
                project,
                null);
        Requirement.create(project, false, "myRequirement", "some description", Map.of("APP", List.of("comp1", "comp2")), new ParentEntity(requirementFolder2), Requirement.Criticality.UNDEFINED);
    ...
    public void testCreateRequirementWithFolder2() {
        ...
        try (MockedStatic<RequirementFolder> mockedRequirementFolder = mockStatic(RequirementFolder.class);
            ...
            Requirement.create(project, false, "myRequirement", "some description", new HashMap<>(), "folder1/folder2", Requirement.Criticality.UNDEFINED);

            verify(postRequest).body(new JSONObject("{\"_type\":\"requirement\",\"parent\":{\"id\":1,\"_type\":\"requirement-folder\"},\"current_version\":{\"_type\":\"requirement-version\",\"name\":\"myRequirement\",\"criticality\":\"UNDEFINED\",\"description\":\"some description\",\"status\":\"WORK_IN_PROGRESS\"}}"));
    ...
    public void testDoNotCreateRequirement() {
        ...
        try (MockedStatic<RequirementFolder> mockedRequirementFolder = mockStatic(RequirementFolder.class);
            ...
            Requirement requirement = Requirement.create(project, false, "myRequirement", "some description", new HashMap<>(), "folder1/folder2", Requirement.Criticality.UNDEFINED);
    ...
    public void testDoNotCreateRequirement2() {
        ...
        try (MockedStatic<RequirementFolder> mockedRequirementFolder = mockStatic(RequirementFolder.class);
            ...
            Requirement requirement = Requirement.create(project, false, "myRequirement", "some description", new HashMap<>(), (String) null, Requirement.Criticality.UNDEFINED);
